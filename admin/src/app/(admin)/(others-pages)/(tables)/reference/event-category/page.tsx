...
export default function EventCategoryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post("http://localhost:3001/api/addCategory", { name });
  ...
  return (  
    <div>
      ...
      <ComponentCard title="Эвентийн ангилал">
        <button
          onClick={openModal}
          type="button"
        ...
        <EventCategoryTable refreshTrigger={refreshKey} />
      </ComponentCard>
